...
<?php include_once "header_1.php" ?>
    <div class="container">
        ...
        <div class="contents">
            <table class="gallery">
                <tr>
                    <td rowspan="2" class="gallery_pic"><a href="#"><img src="../img/img부산현대2.PNG"></a></td>
                    <td class="gallery_nm2"><a href="#">부산현대미술관</a></td>
                </tr>
                <tr>
                    <td class="gallery_intro"><img src="../img/부산미술관.PNG"></td>
                </tr>
                <tr>
                    <td rowspan="2" class="gallery_pic"><a href="#"><img src="../img/img부산시립2.PNG"></a></td>
                    <td class="gallery_nm2"><a href="#">부산시립미술관</a></td>
                </tr>
                <tr>
                    <td class="gallery_intro"><img src="../img/부산시립미술관.PNG"></td>
                </tr>
                <tr>
                    <td rowspan="2" class="gallery_pic"><a href="#"><img src="../img/img고은사진미술관2.png"></a></td>
                    <td class="gallery_nm2"><a href="#">고은사진미술관</a></td>
                </tr>
                <tr>
                    <td class="gallery_intro"><img src="../img/고은사진미술관.PNG"></td>
                </tr>
            </table>
        </div>
    </div>
